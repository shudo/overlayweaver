...
/**
 * A test class for {@link ow.util.ClassTraversaler ClassTraversaler} class.
 * Lists up classes whose name starts with "ow.".
 */
public class ClassTraversalTest {
	public static void main(String[] args) {
		...
		traverser.traversal("ow.routing.RoutingServiceFactory");
	}
}
