...
public final class DisconnectAndRefuseMessage extends Message {
	public final static String NAME = "DISCONNECT_AND_REFUSE";
	...
	public DisconnectAndRefuseMessage() { super(); }	// for Class#newInstance()

	public DisconnectAndRefuseMessage(
			ID groupID) {
