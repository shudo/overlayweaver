...
public final class ConnectNodesMessage extends Message {
	public final static String NAME = "CONNECT_NODES";
	...
	public ConnectNodesMessage() { super(); }	// for Class#newInstance()

	public ConnectNodesMessage(
