...
public final class DeleteNodeMessage extends Message {
	public final static String NAME = "DELETE_NODE";
	public final static boolean TO_BE_REPORTED = false;
	public final static Color COLOR = null;

	// message members
	public MessagingAddress node;

	public DeleteNodeMessage() { super(); }	// for Class#newInstance()

	public DeleteNodeMessage(
			MessagingAddress node) {
		this.node = node;
	}
	...
	public void decodeContents(ObjectInputStream ois) throws IOException, ClassNotFoundException {
		this.node = (MessagingAddress)ois.readObject();
	}
}
