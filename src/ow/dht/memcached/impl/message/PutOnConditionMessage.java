...
package ow.dht.memcached.impl.message;
...
public final class PutOnConditionMessage extends Message {
	public final static String NAME = "PUT_ON_CONDITION";
	public final static boolean TO_BE_REPORTED = true;
	public final static Color COLOR = null;

	// message members
	public Memcached.PutRequest[] requests;
	public long ttl;
	public ByteArray hashedSecret;
	public int numReplica;

	public PutOnConditionMessage() { super(); }	// for Class#newInstance()

	public PutOnConditionMessage(
			Memcached.PutRequest[] requests, long ttl, ByteArray hashedSecret, int numReplica) {
	...
	public void decodeContents(ObjectInputStream ois) throws IOException, ClassNotFoundException {
		this.requests = (Memcached.PutRequest[])ois.readObject();
