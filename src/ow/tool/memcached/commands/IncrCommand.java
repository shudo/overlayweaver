...
public final class IncrCommand extends AbstractIncrDecrCommand {
	private final static String[] NAMES = {"incr"};

	public String[] getNames() { return NAMES; }

	public String getHelp() {
		return "incr <key> <value> [noreply]";
	}

	public boolean execute(ShellContext<Memcached> context) {
		return super.incrOrDecr(context, true);
	}
}
