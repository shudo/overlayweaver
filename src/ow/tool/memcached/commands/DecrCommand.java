...
public final class DecrCommand extends AbstractIncrDecrCommand {
	private final static String[] NAMES = {"decr"};

	public String[] getNames() { return NAMES; }

	public String getHelp() {
		return "decr <key> <value> [noreply]";
	}

	public boolean execute(ShellContext<Memcached> context) {
		return super.incrOrDecr(context, false);
	}
}
