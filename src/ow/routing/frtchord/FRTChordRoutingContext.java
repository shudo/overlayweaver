...
public class FRTChordRoutingContext extends RoutingContext {
	private boolean routeToPredecessorOfTarget = false;
	private boolean onLastPhase = false;

	public FRTChordRoutingContext() {}

	private FRTChordRoutingContext(boolean routeToPredecessorOfTarget, boolean onLastPhase) {
		this.routeToPredecessorOfTarget = routeToPredecessorOfTarget;
		this.onLastPhase = onLastPhase;
	}

	protected FRTChordRoutingContext(FRTChordRoutingContext c) {	// for clone()
		super(c);
	...
	public boolean equals(Object o) {
		if (o instanceof FRTChordRoutingContext) {
			FRTChordRoutingContext c = (FRTChordRoutingContext)o;
	...
	public FRTChordRoutingContext clone() {
		return new FRTChordRoutingContext(this.routeToPredecessorOfTarget, this.onLastPhase);
	}
}
