...
package ow.routing.chord.message;
...
public final class UpdateFingerTableMessage extends Message {
	public final static String NAME = "UPDATE_FINGER_TABLE";
