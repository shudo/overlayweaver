...
public final class IteRouteJoinMessage extends AbstractIteRouteMessage {
	public final static String NAME = "ITE_ROUTE_JOIN";
	public final static boolean TO_BE_REPORTED = true;
	public final static Color COLOR = Color.BLUE;

	public IteRouteJoinMessage() { super(); }	// for Class#newInstance()

	public IteRouteJoinMessage(
