...
public final class RecRouteNoneMessage extends AbstractRecRouteMessage {
	public final static String NAME = "REC_ROUTE_NONE";
	public final static boolean TO_BE_REPORTED = true;
	public final static Color COLOR = Color.BLUE;

	public RecRouteNoneMessage() { super(); }	// for Class#newInstance()

	public RecRouteNoneMessage(
