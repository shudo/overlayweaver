...
public final class RepLeafSetMessage extends Message {
	public final static String NAME = "REP_LEAF_SET";
	...
	public RepLeafSetMessage() { super(); }	// for Class#newInstance()

	public RepLeafSetMessage(
